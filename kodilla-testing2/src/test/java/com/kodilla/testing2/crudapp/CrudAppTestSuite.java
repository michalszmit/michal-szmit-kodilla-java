...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://michalszmit.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("michalrd@gmail.com");		        // [3]
        driverTrello.findElement(By.id("password")).sendKeys("kodilla123");		    // [4]
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();									                                // [5]

        Thread.sleep(4000);								                            // [6]

        driverTrello.findElement(By.id("password")).sendKeys("kodilla123");		    // [7]

...
public class FacadeTestSuite {
    @Autowired
    private EmployeeCompanySearchFacade employeeCompanySearchFacade;
    ...
    public void searchCompaniesByPartialNameTest(){
        ...
        //When
        List<Company> resultCompaniesByPartialName = employeeCompanySearchFacade.searchCompaniesByPartialName("ma");
        //Then
    ...
    @Test
    public void searchEmployeesByPartialNameTest() {
        //Given
        Employee johnSmith = new Employee("John", "Smith");
        Employee stephanieClarckson = new Employee("Stephanie", "Clarckson");
        Employee lindaKovalsky = new Employee("Linda", "Kovalsky");
